//This calculates and displays the (int) surface area and (int) volume of a cube based on its side length.
...
public class Main {
    ...
    //prints out the calculated value of the Surface Area or the Volume of a cube. 
